...
public class VoprosLatex implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "VOPROS_ID_VOPROS", 
                referencedColumnName = "ID_VOPROS"),
        @JoinColumn(name = "VOPROS_KATEGORIYA_SLOZHNOSTI_ID_ KATEGORIYA_SLOZHNOSTI", 
                referencedColumnName = "KATEGORIYA_SLOZHNOSTI_ID_ KATEGORIYA_SLOZHNOSTI"),
        @JoinColumn(name = "VOPROS_TIP_VOPROSA_ID_ TIP_VOPROSA", 
                referencedColumnName = "TIP_VOPROSA_ID_ TIP_VOPROSA")})
    ...
    public boolean equals(Object object) {
        ...
        return !((this.idVoprosLatex == null && other.idVoprosLatex != null) || 
